...
This is a deliberate architectural choice, not a missing feature. Context optimization should happen at the source, not in a dashboard after the fact. And it should be free, open-source, and community-driven. Licensed under [Elastic License 2.0](LICENSE) — free to use, modify, and share. The only restriction: you can't take this work, rebrand it, and sell it as a competing product. Everything else is fair game.
