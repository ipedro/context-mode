...
- DO NOT use shell tool for commands producing >20 lines of output — use `mcp__context-mode__execute` or `mcp__context-mode__batch_execute`.
- DO NOT use read_file for analysis — use `mcp__context-mode__execute_file`. read_file IS correct for files you intend to edit.
- DO NOT use web_fetch — use `mcp__context-mode__fetch_and_index` instead.
- DO NOT use curl/wget in shell — use `mcp__context-mode__execute` or `mcp__context-mode__fetch_and_index`.
